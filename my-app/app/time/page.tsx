...
const YEAR_END_TARGET = new Date(2026, 11, 11, 0, 0, 0);
...
export default function TimePage() {
  const [nowMs, setNowMs] = useState(START_DATE.getTime());
  ...
  const elapsedMs = Math.max(0, nowMs - START_DATE.getTime());
      ...
      <div className="time-center">
        <div className="time-stack time-zoom">
          ...
          <div className="time-secondary time-tertiary">
            <div className="time-label">time left till December 2026</div>
            <div className="time-value" aria-live="polite">
              {yearEndMonths.toLocaleString(undefined, {
