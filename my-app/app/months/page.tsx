...
const months = [
  { name: "January", message: "Your hair; the way it smells, and the way you tie it or leave it open. I will still one day replace all your hair er jinish with my 7in1 body wash so u can experience real hair care 😎 " },
